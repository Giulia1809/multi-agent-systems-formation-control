...
%In this case, one obstacle is in the path of the robots - hence, single obstacle - and another one is close to the path of the most external follower.
...
%obstacles list
obstacle_pos = {[0.2, 0.5], [0.2, 1.8]}; %cell array
%obstacle_pos = {[0.2, 0.5]};
...
ylabel('y [m]');
xlabel('x [m]');
saveas(gcf, 'plots_elliptical_singleObstacle/trajectories_des.png');
...
ylabel('y [m]');
xlabel('x [m]');
saveas(gcf, 'plots_elliptical_singleObstacle/trajectories.png');
...
saveas(gca, 'plots_elliptical_singleObstacle/distances.png');
...
saveas(gca, 'plots_elliptical_singleObstacle/angles.png');
